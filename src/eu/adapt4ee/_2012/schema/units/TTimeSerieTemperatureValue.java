...
/**
 * <p>Java class for tTimeSerieTemperatureValue complex type.
 * 
 ...
 *         &lt;element name="value" type="{http://www.adapt4ee.eu/2012/schema/units/}tTemperatureValue"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "tTimeSerieTemperatureValue", propOrder = {
    "timeStart",
    "timeEnd",
    "value"
})
public class TTimeSerieTemperatureValue {
    ...
    @XmlElement(required = true)
    protected TTemperatureValue value;
     ...
     *     
     */
    public TTemperatureValue getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(TTemperatureValue value) {
        this.value = value;
    }
