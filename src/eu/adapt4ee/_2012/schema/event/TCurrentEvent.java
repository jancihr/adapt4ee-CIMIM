...
import eu.adapt4ee._2012.schema.units.TCurrentValue;


/**
 * <p>Java class for tCurrentEvent complex type.
 * 
 ...
 *         &lt;element name="value" type="{http://www.adapt4ee.eu/2012/schema/units/}tCurrentValue"/>
...
@XmlType(name = "tCurrentEvent", propOrder = {
    "time",
    "value",
    "spaceRef",
    "sensorRef"
})
public class TCurrentEvent {

    @XmlElement(required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar time;
    @XmlElement(required = true)
    protected TCurrentValue value;
     ...
     *     
     */
    public void setValue(TCurrentValue value) {
        this.value = value;
    }
