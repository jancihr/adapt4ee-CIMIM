...
/**
 * <p>Java class for tEnergyEvent complex type.
 * 
 ...
 *         &lt;element name="value" type="{http://www.adapt4ee.eu/2012/schema/units/}tEnergyValue"/>
...
@XmlType(name = "tEnergyEvent", propOrder = {
    "time",
    "value",
    "spaceRef",
    "sensorRef"
})
public class TEnergyEvent {

    @XmlElement(required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar time;
    @XmlElement(required = true)
    protected TEnergyValue value;
     ...
     *     
     */
    public void setValue(TEnergyValue value) {
        this.value = value;
    }
